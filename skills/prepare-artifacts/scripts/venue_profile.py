...
This module is the shared profile loader for the prepare-camera-ready scripts
(vendored from preflight-check so each skill stays self-contained).
...
def main() -> int:
    ap = argparse.ArgumentParser(
        ...
        "the result as JSON. Shared loader for the prepare-camera-ready "
        "scripts (vendored from preflight-check)."
    )
